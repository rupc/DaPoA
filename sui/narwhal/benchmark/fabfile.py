...
def local(ctx, debug=True):
    ...
    node_params = {
        ...
        'max_header_delay': '500ms',  # ms
        "min_header_delay": "250ms",
        'max_batch_delay': '250ms',  # ms,
        'gc_depth': 50,  # rounds
        'sync_retry_delay': '10_000ms',  # ms
        'sync_retry_nodes': 3,  # number of nodes
        'batch_size': 30_000_000,  # 30MB
        'block_synchronizer': {
            'range_synchronize_timeout': '120_000ms',
            'certificates_synchronize_timeout': '8_000ms',
            'payload_synchronize_timeout': '8_000ms',
            'payload_availability_timeout': '8_000ms',
            'handler_certificate_deliver_timeout': '4_000ms'
        },
        "consensus_api_grpc": {
    ...
    #     'max_header_delay': '4000ms',  # ms
    #     'gc_depth': 50,  # rounds
    #     'sync_retry_delay': '10_000ms',  # ms
    #     'sync_retry_nodes': 3,  # number of nodes
    #     'batch_size': 20_000_000,  # 20MB 
    #     'max_batch_delay': '1500ms',  # ms,
    #     'block_synchronizer': {
    #         'range_synchronize_timeout': '60_000ms',
    #         'certificates_synchronize_timeout': '4_000ms',
    #         'payload_synchronize_timeout': '4_000ms',
